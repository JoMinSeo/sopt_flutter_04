...
import 'package:sopt_flutter_04/features/song/presentation/providers/album_songs_provider.dart';
    ...
    return Column(
      ...
      children: [
        ...
        songs.when(
          ...
          data: (tracks) {
            final others =
                tracks.where((t) => t.trackId != currentTrackId).toList()
                  ..sort(
                    (a, b) =>
